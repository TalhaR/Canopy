...
const HomePage = () => {
    ...
    return (
        <Box p={5} component="section" className={classes.root}>
            ...
            <Typography variant="h6">
                A market where stock buyers connect with stock sellers. The most prominent exchanges include the New York Stock Exchange(NYSE), NASDAQ, and the Japan Exchange Group.
            </Typography>
            <br />
            ...
            <Typography variant="h6">
                Over-the-counter or off-exchange trading is done directly between two parties, without the supervision of an exchange. OTC trading is necessary for securities that do not meet the strict requirements to be listed on exchanges (such as having at least 1.1 million publicly traded shares outstanding with a collective market value of at least $100 million for NYSE).
            </Typography>
            <br />
            ...
            <Typography variant="h6">
                The condition of a financial market in which securityprices are rising or are expected to rise. Bull markets tend to last for months or even years.
            </Typography>
            <br />
            ...
            <Typography variant="h6">
                The number of shares of a security traded between its daily open and close. Generally the higher the volume, the more liquid a stock is.
            </Typography>
            <br />
            ...
            <Typography variant="h6">
                How rapidly shares of a stock can be bought or sold without substantially impacting the stock price. Stocks with low liquidity may be difficult to sell at the price that you want, as the bid-ask spread is much larger.
            </Typography>
            <br />
            ...
            <Typography variant="h6">
                A dividend is a payment made by publicly-listed companies as a reward to its shareholders. Dividends may be paid out as cash or in th form of additional stock.
            </Typography>
            <br />
            ...
            <Typography variant="h6">
                The number of shares available to be traded by the public. It can be found by subtracting the total number of closely held shares (by company insiders, employees, etc.) from the total number of outstanding shares. A company's float is an important number for investors because it indicates how many shares are actually available to be bought and sold by the general investing public.
            </Typography>
            <br />
